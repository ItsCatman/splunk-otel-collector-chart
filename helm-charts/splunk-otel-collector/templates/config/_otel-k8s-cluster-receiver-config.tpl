...
processors:
  ...
  transform/k8sobjects:
    log_statements:
      - statements:
          - set(resource.attributes[Concat(["k8s", ConvertCase(log.body["kind"], "lower"), "name"], ".")], log.body["metadata"]["name"])
          - set(resource.attributes[Concat(["k8s", ConvertCase(log.body["kind"], "lower"), "uid"], ".")], log.body["metadata"]["uid"])
      - conditions:
